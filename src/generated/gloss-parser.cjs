...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { GlossWithImplicitLiterals: peg$parseGlossWithImplicitLiterals, GlossWithImplicitPointers: peg$parseGlossWithImplicitPointers },
  ...
  function peg$parseInflectionList() {
    var s0, s1, s2, s3, s4;
  ...
  function peg$parseImplicitLiteral() {
    ...
    s0 = peg$parseGeneratedLiteral();
    if (s0 === peg$FAILED) {
      s0 = peg$parseHandcraftedLiteral();
    }

    return s0;
  }

  function peg$parseHandcraftedLiteral() {
    var s0, s1;
  ...
  function peg$parseGeneratedLiteral() {
    var s0, s1, s2;
  ...
  function peg$parseCompoundWithImplicitLiterals() {
  ...
  function peg$parseCompoundWithImplicitPointers() {
    var s0, s1, s2, s3, s4, s5, s6;
