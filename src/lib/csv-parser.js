...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$startRuleFunctions = { CSV: peg$parseCSV },
        peg$startRuleFunction  = peg$parseCSV,
    ...
    function peg$parseCell() {
      ...
      s0 = peg$parseQuotedCell();
      if (s0 === peg$FAILED) {
        s0 = peg$parseUnquotedCell();
      }

      return s0;
    }

    function peg$parseQuotedCell() {
      var s0, s1, s2, s3;
    ...
    function peg$parseLiteralChars() {
      var s0, s1, s2;
    ...
    function peg$parseUnquotedCell() {
      var s0, s1, s2;
